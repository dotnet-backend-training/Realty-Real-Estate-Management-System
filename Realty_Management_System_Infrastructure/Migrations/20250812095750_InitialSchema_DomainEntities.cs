...
{
    /// <inheritdoc />
    public partial class InitialSchema_DomainEntities : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NearbyPlaceTypes", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PriceUnitTypes", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                name: "PropertyTourRequestStatuses",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PropertyTourRequestStatuses", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PriceUnitTypeId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PriceUnits_PriceUnitTypes_PriceUnitTypeId",
                        column: x => x.PriceUnitTypeId,
                        principalTable: "PriceUnitTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumberOfGarage = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Properties_PriceUnits_PriceUnitId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PropertyReviewId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    NearbyPlaceTypeId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    PropertyId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    DistanceInKm = table.Column<double>(type: "float(6)", precision: 6, scale: 2, nullable: false),
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_NearbyPlaces", x => new { x.NearbyPlaceTypeId, x.PropertyId });
                    table.ForeignKey(
                        name: "FK_NearbyPlaces_NearbyPlaceTypes_NearbyPlaceTypeId",
                        column: x => x.NearbyPlaceTypeId,
                        principalTable: "NearbyPlaceTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                name: "PropertyCategoryAssociations",
                columns: table => new
                {
                    PropertyId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PropertyCategoryAssociations", x => new { x.PropertyId, x.PropertyCategoryId });
                    table.ForeignKey(
                        name: "FK_PropertyCategoryAssociations_Properties_PropertyId",
                        column: x => x.PropertyId,
                        principalTable: "Properties",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PropertyCategoryAssociations_PropertyCategories_PropertyCategoryId",
            ...
            migrationBuilder.CreateTable(
                name: "PropertyFeatureAssociations",
                columns: table => new
                {
                    PropertyId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PropertyFeatureAssociations", x => new { x.PropertyId, x.PropertyFeatureId });
                    table.ForeignKey(
                        name: "FK_PropertyFeatureAssociations_Properties_PropertyId",
                        column: x => x.PropertyId,
                        principalTable: "Properties",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PropertyFeatureAssociations_PropertyFeatures_PropertyFeatureId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PropertyTourRequestStatusId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    PropertyId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PropertyTourRequests", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PropertyTourRequests_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PropertyTourRequests_Properties_PropertyId",
                        column: x => x.PropertyId,
                        principalTable: "Properties",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PropertyTourRequests_PropertyTourRequestStatuses_PropertyTourRequestStatusId",
                        column: x => x.PropertyTourRequestStatusId,
                        principalTable: "PropertyTourRequestStatuses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PropertyReviews_Contracts_ContractId",
                        column: x => x.ContractId,
                        principalTable: "Contracts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Transactions_PropertyReviews_PropertyReviewId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PriceUnits_Abbreviation",
                table: "PriceUnits",
                column: "Abbreviation",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_PriceUnits_Name",
                table: "PriceUnits",
                column: "Name",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_PriceUnits_PriceUnitTypeId",
                table: "PriceUnits",
                column: "PriceUnitTypeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Properties_PriceUnitId",
                table: "Properties",
                column: "PriceUnitId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PropertyCategoryAssociations_PropertyCategoryId",
                table: "PropertyCategoryAssociations",
                column: "PropertyCategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_PropertyFeatureAssociations_PropertyFeatureId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PropertyReviews_ContractId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PropertyTourRequests_PropertyId",
                table: "PropertyTourRequests",
                column: "PropertyId");

            migrationBuilder.CreateIndex(
                name: "IX_PropertyTourRequests_PropertyTourRequestStatusId",
                table: "PropertyTourRequests",
                column: "PropertyTourRequestStatusId");

            migrationBuilder.CreateIndex(
                name: "IX_PropertyTourRequests_UserId",
                table: "PropertyTourRequests",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transactions_PropertyReviewId",
                table: "Transactions",
                column: "PropertyReviewId",
                unique: true,
                filter: "[PropertyReviewId] IS NOT NULL");
